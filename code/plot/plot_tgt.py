...
for idx in range(1, 3):
    ...
    os.system(f'python3 code/plot/plot_tgt_mass.py --DM DM --feat_idx {idx} --charac Charac_')
    os.system(f'python3 code/plot/plot_tgt_mass.py --DM Hydro --feat_idx {idx} --charac Charac_')
    
    os.system(f'python3 code/plot/plot_tgt_mass.py --DM DM --feat_idx {idx} --charac Charac_ --zmax 2')
    os.system(f'python3 code/plot/plot_tgt_mass.py --DM Hydro --feat_idx {idx} --charac Charac_ --zmax 2')
...
# # Plot profiles per redshift
# cuts = np.linspace(1, 4, 7)
# for cut in cuts:
#     os.system(f'python3 code/plot/median_profiles.py --sim TNG300 --DM DM --mass_cut {cut}')
    
# cuts = np.linspace(1.5, 4, 6)
# for cut in cuts:
#     os.system(f'python3 code/plot/median_profiles.py --sim TNG300 --DM Hydro --mass_cut {cut}')

# cuts = np.linspace(3, 5, 5)
# for cut in cuts:
#     os.system(f'python3 code/plot/median_profiles.py --sim MTNG --DM DM --mass_cut {cut}')
    
# cuts = np.linspace(3, 5, 5)
# for cut in cuts:
#     os.system(f'python3 code/plot/median_profiles.py --sim MTNG --DM Hydro --mass_cut {cut}')
