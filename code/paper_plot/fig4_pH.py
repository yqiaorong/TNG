...
print('')
print(f'>>> Plot depth and width vs z (peak height) <<<')
print('')
...
root_dir = 'result/bootstrap_stats/with_peakHeight/'
simus = ['Hydro', 'DM']
...
for simu in simus:
    for feature in features:
        ...
        min_bin, max_bin, bin_width = 0, 1, 0.2
        ...
        plt.savefig(f'{save_dir}/fig4_peakHeight_{simu}_{feature}')
        plt.close()